...
venn.diagram(list(A = sets[[1]], B = sets[[2]], C = sets[[3]], D = sets[[4]]), 
             filename = "Venn_1.tiff")

venn.diagram(list(A = sets[[1]], B = sets[[2]], C = sets[[3]], D = sets[[4]],
                  E = 300:310), 
             filename = "Venn_2.tiff")

venn.diagram(list(A = sets[[1]], B = sets[[2]]), 
             filename = "Venn_3.tiff",
             fill = c("cornflowerblue", "darkorchid1")) ##color
@
